...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node [line width=2pt] at (7.5cm, -9cm) {\includegraphics[width=10cm]{./imagenes/portada.png}};
    ...
    \node at (7.5cm, -14cm) {\scalebox{3}{\textbf{Trabajo práctico Nº5}}};
    \node at (7.5cm, -23.5cm) {
	\begin{minipage}[c]{12cm}
	    \begin{itemize}
            \raggedright
            \item \fontsize{12}{12}\selectfont \textbf{Autores:} 
                \begin{itemize} \item Mariano Alberto Condori - Leg. 406455 (Coordinador)\item Ignacio Ismael Perea - Leg. 406265 (Operador) \item Gonzalo Ezequiel Filsinger - Leg. 403797 (Operador/Doc.)  \item Marcos Acevedo - Leg. 402898 (Doc)\end{itemize}
