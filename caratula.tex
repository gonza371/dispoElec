	...
	\begin{minipage}[c]{12cm}
	    \begin{itemize}
            ...
            \item \fontsize{12}{12}\selectfont \textbf{Autores:} 
                \begin{itemize} \item Gonzalo Ezequiel Filsinger - Leg. 403797 (Coordinador) \item Ignacio Ismael Perea - Leg.  (Doc) \item Mariano Alberto Condori - Leg. (Operador) \item Marcos Acevedo - Leg. (Doc)\end{itemize}
